...
class SpawnTurtle(Node):
    ...
    def __init__(self):
        ...
        for i in range(self.total):
            ...
            self.cmd_publishers.append(self.create_publisher(Twist, topic, qos_profile=self.qos_profile))
        freq = 5  # Hz
...
def main(args=None):
    ...
    for i in range(spawn_turtle.total):
        ...
        spawn_turtle.get_logger().info('Turtle successfully spawned with name %s' % response.name)
