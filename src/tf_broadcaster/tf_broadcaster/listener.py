...
class TfListener(Node):
    def __init__(self, first_turtle, second_turtle):
        """
        Tf listener where 2nd turtle follows the 1st turtle.
        """
    ...
    def timer_callback(self):
        """
        Gets the transform, compute target velocities, and publishes the cmd_vel message.
        """
        try:
...
def main(argv=None):
    """
    args[1]: first turtle name (target)
    args[2]: second turtle name (follower)
    """
